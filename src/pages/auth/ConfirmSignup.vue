                        ...
                        <div class="kt-login-v1__wrapper" v-if="$route.query.token">
                            <div class="kt-login-v1__container">
                                <h3 class="kt-login-v1__title">
                                    Please click confirm your account!
                                </h3>
                                ...
                                <div class="kt-login-v1__form kt-form" autocomplete="off">
                                    <div class="kt-login-v1__actions" style="justify-content: center;">
                                        <button @click="submit" ref="submit" class="btn btn-pill btn-elevate">Confirm Account</button>
                                    </div>
                                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            submit() {
                this.$store.dispatch('auth/actConfirmSignup', {

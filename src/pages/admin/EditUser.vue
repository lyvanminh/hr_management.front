                ...
                <div class="kt-wizard-v3" id="kt_wizard_v3" data-ktwizard-state="step-first">
                    ...
                    <form class="kt-form" id="kt_form">
                        ...
                        <div class="kt-wizard-v3__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
                            <div class="kt-heading kt-heading--md">Cập nhật Account</div>
                            ...
                            <div class="kt-form__section kt-form__section--first">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="username" v-model="user.username" value="" required>
                                    <span class="form-text text-muted">Please enter your username</span>
                                </div>
                                <div class="form-group">
                                    <label>Họ và Tên:</label>
                                    <input type="email" class="form-control" name="name" v-model="user.name" value="" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status" v-model="user.status">
                        ...
                        <div class="kt-form__actions">
                            <div @click="updateUser" class="btn btn-brand btn-md btn-tall btn-wide btn-bold btn-upper" data-ktwizard-type="action-submit" style="cursor: pointer">
                                Done
                            </div>
                        </div>
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            user: 'user/getUserFind'
        })
    },
    mounted() {
        this.username = this.$route.params.username;
        let vm = this;
        this.$store.dispatch('user/actGetUserByUsername', {
    ...
    methods: {
        validateForm() {
            ...
            // }
            //
            // if (!this.form.confirm_password || this.form.confirm_password !== this.user.password) {
        ...
        updateUser() {
            ...
            this.$store.dispatch('user/actUpdateUser', {
                body: vm.user,
                id: vm.user.id,
                callback: callback
            });
